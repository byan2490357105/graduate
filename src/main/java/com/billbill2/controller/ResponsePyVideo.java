...
//    @PostMapping("/getvideo")
//    @ResponseBody
//    public Map<String, Object> getVideo(@RequestBody Map<String, String> request) {
//        Map<String, Object> resultMap = new HashMap<>();
//        try {
//            String bvNum = request.get("bvNum");
//            String savePath = request.getOrDefault("savePath", defaultSavePath);
//
...
//                resultMap.put("data", videoData);
//                //视频isDownload为1，表明已经成功下载
//                videoData.setIsDownload(1);
//                //获取成功，入库
//                videoService.saveOrUpdateVideoByBvNum(videoData);
//            }else{
